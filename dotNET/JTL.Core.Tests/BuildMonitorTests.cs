...
namespace JTL.Core.Tests
{
    ...
    public class BuildMonitorTests
    {
        ...
        [TestCase(RssSamples.CurrentlyStable, BuildStatus.Successful, TestName = "Status should be Successful when the last build was succesful.")]
        ...
        [TestCase(RssSamples.BackToNormal, BuildStatus.Successful, TestName = "Status should be Successful when the last build returned to normal.")]
        [TestCase(RssSamples.Stable, BuildStatus.Successful, TestName = "Status should be unknown when the last two builds were successful")]
